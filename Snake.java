...
public class Snake {
    ...
    public int position = 0;   //Movement direction (0 - right, 1 - down, 2 - left, 3 - up)
    ...
    public void move(){
        ...
        if(position == 0) snakeX[0]++;
        if(position == 1) snakeY[0]++;
        if(position == 2) snakeX[0]--;
        if(position == 3) snakeY[0]--;
